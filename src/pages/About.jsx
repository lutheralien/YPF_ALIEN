    ...
    <div>
        ...
        <div className='w-[100vw] shadow-lg h-[40vh] lg:h-[60vh] flex items-center'>
            <div className='absolute z-10 w-full text-white px-6 md:px-20 flex flex-col gap-2 md:gap-5'>
                <h1 className='text-4xl md:text-6xl font-semibold text-orange pb-3'>Our Story</h1>
                <div className='w-full h-0.5 bg-orange mx-2' />
                <p className='md:text-3xl font-semibold'>Changing Lives With Kindness</p>
            </div>
        ...
        <div className='flex-col flex bg-white py-12 my-2'>
            ...
            <div className='flex flex-col-reverse lg:flex-row items-center gap-4 mx-4 md:mx-10 mt-10'>
                ...
                <div className='flex flex-col gap-4'>
                    <h3 className='text-3xl md:text-4xl text-orange'>Who We Are</h3>
                    <div className='text-lg md:text-xl leading-[1.2] flex flex-col gap-2'>
        ...
        <div className='bg-white flex flex-col lg:flex-row lg:gap-20 py-12 px-4 md:px-12 lg:px-20 items-center md:w-full'>
            <div className='flex flex-col gap-6 lg:w-[110vw]'>
                <h3 className='text-3xl md:text-4xl text-orange'>Our Mission</h3>
                <p className='text-lg md:text-xl leading[1.3]'>Our purpose is to empower the underprivileged by providing them with the tools, resources, and support they need to improve their lives. We focus on creating sustainable solutions that not only address immediate needs but also foster long-term change. Through education, community development, and direct aid, we strive to uplift communities and create a future where everyone has the opportunity to thrive.</p>
            </div>
            <div className='flex items-center gap-12 '>
                <div className='flex flex-col items-center gap-16'>
                    <div className='drop-shadow-2xl shadow-custom-orange p-3 relative py-12'>
        ...
        <div className='bg-white flex flex-col lg:flex-row-reverse lg:gap-20 py-12 px-4 md:px-12 lg:px-20 items-center w-full'>
            <div className='flex flex-col gap-3 lg:gap-6 lg:w-[110vw]'>
                <h3 className='text-3xl md:text-4xl text-orange'>Our Vision</h3>
                <p className='text-lg md:text-xl leading[1.3]'> At YPF,we aim to bring positive, lasting change to the lives of those who need it most."
                    <br /><br />
